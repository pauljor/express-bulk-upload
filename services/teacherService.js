        ...
        const createPromises = sheetData.map(async (teacher) => {
            ...
            try {
                ...
                if (err.message === "Email already exists") {
                    console.warn(`Teacher with email ${teacher.email} already exists. Skipping.`);
                    failureReasons.push("Email already exists");
                } else {
                    console.error(`Error creating teacher: ${teacher.email}`, err);
                    failureReasons.push("Failed to create teacher in the system");
                }
